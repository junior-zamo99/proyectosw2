...
@Module({
  ...
  imports: [
    ...
    MongooseModule.forRoot('mongodb+srv://houwenvt:will@cluster0.crz8eun.mongodb.net/EcommerTenants'),
    MongooseModule.forRoot('mongodb+srv://houwenvt:will@cluster0.crz8eun.mongodb.net/EcommerTenants', { connectionName: 'logsConnection' }),
    UsuarioModule,
    ProductoModule,
    LogModule,
    RolModule,
